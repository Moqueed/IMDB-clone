  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <input
        value={search}
        placeholder="Search..."
        className="h-[4rem] p-4 w-[24rem] text-2xl my-8 bg-slate-200 outline-none"
        onChange={(e)=>setSearch(e.target.value)}
      />
      <table className="rounded-xl border-2 m-4 w-[90%] overflow-hidden">
        <thead className="bg-slate-300 h-12 rounded-lg">
          <tr className="border-b-2 text-left">
            <th className="p-8">Name</th>
            <th>
              <i onClick={()=>sortAscending('vote_average')} class="fa-solid fa-angle-up mr-2"></i>Ratings
              <i onClick={()=>sortDescending('vote_average')} class="fa-solid fa-angle-down ml-2"></i>
            </th>
            <th>
              <i onClick={()=>sortAscending('popularity')} class="fa-solid fa-angle-up mr-2"></i>Popularity
              <i onClick={()=>sortDescending('popularity')} class="fa-solid fa-angle-down ml-2"></i>
            </th>
            <th>Genre</th>
            <th></th>
          </tr>
